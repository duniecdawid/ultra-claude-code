...
RAILWAY_API_TOKEN=<token> railway variable list -s api-server

# List for a specific environment
RAILWAY_API_TOKEN=<token> railway variable list -e staging

# JSON output (useful for scripting)
RAILWAY_API_TOKEN=<token> railway variable list --json
```
...
RAILWAY_API_TOKEN=<token> railway variable set DATABASE_URL=postgres://...

# Set multiple variables at once
RAILWAY_API_TOKEN=<token> railway variable set KEY1=value1 KEY2=value2

# Set for a specific service and environment
RAILWAY_API_TOKEN=<token> railway variable set -s api-server -e staging SECRET_KEY=abc123
```
...
```bash
# Delete a variable
RAILWAY_API_TOKEN=<token> railway variable delete SECRET_KEY

# Delete for a specific service
RAILWAY_API_TOKEN=<token> railway variable delete -s api-server OLD_VAR
```
...
RAILWAY_API_TOKEN=<token> railway run <command>

# Example: run your app locally with production env vars
RAILWAY_API_TOKEN=<token> railway run npm start

# Open a shell with all variables available
RAILWAY_API_TOKEN=<token> railway shell
```
...
RAILWAY_API_TOKEN=<token> railway environment
...
RAILWAY_API_TOKEN=<token> railway environment new staging
```
...
RAILWAY_API_TOKEN=<token> railway environment delete old-staging
```
