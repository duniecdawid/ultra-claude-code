...
Connects to the Ultra Claude Dashboard at `dashboard.ultra-claude.dev` for real-time project visibility. Guides agent installation, setup, and verifies connectivity with self-contained debug checks. Use when setting up dashboard sync, troubleshooting agent connectivity, or checking sync status.
